...
import zy.blue7.jsontoobj.enity.JavaObj;
import zy.blue7.jsontoobj.handlers.Handler;
import zy.blue7.jsontoobj.services.JsonToObj;
...
//        Handler handler=new Handler<JavaObj>();
//        JavaObj obj = (JavaObj) handler.handle("zy.blue7.jsontoobj.enity.JavaObj", JSON.parseObject(str),environment);
//        System.out.println(obj);
        JavaObj javaObj= (JavaObj) jsonToObj.start("zy.blue7.jsontoobj.enity.JavaObj", str,environment);
